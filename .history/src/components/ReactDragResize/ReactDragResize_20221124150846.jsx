import React, {
  memo, useState, useEffect, useCallback, useMemo, useRef, forwardRef, useImperativeHandle,
} from 'react';
...
const ReactDragResize = memo(forwardRef((props, ref) => {
  ...
  const [, setDimensionsBeforeMove, dimensionsBeforeMoveSync] = useSyncState({
    pointerX: 0, pointerY: 0, left: 0, right: 0, top: 0, bottom: 0, width: 0, heihgt: 0,
  }, false);
  ...
  const {
    recordHistorySteps, recordCurrentSteps, getHistorySteps, historyStepsSync, setCurStep, curStepSync,

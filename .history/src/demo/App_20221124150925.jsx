  ...
  return (
    <AppWrapper>
      ...
      <div className="left-content">
        <ReactDragResize isConflictCheck style={{ backgroundColor: 'pink' }} w={200} h={200} historyStepsLength={30} ref={ReactDrageResizeRef} isConflictCheck>
          操作块之后可以回退
        </ReactDragResize>
        <ReactDragResize isConflictCheck style={{ backgroundColor: 'pink' }} w={200} h={200} x={300} y={300} historyStepsLength={30} ref={ReactDrageResizeRef} isConflictCheck>
          操作块之后可以回退
        </ReactDragResize>
      </div>
